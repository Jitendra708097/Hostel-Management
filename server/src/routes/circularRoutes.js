...
const { uploadCircular, getAllCirculars, getCircularById, viewCircularById, deleteCircularById, updateCircularById } = require('../controllers/circularControllers');
const userMiddleware = require('../middleware/userMiddleware');
const adminMiddleware = require('../middleware/adminMiddleware');


// for students 
circularRouter.get('/view/:_id',userMiddleware, viewCircularById);  //stream circular file by id
...
// for admin 
circularRouter.post('/upload', adminMiddleware, upload.circular.single('circular'), uploadCircular); //upload media function from controller
